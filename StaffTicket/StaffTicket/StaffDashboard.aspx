                ...
                <header id="header" class="hoc clear">
                    ...
                    <nav id="mainav" class="fl_right">
                        <ul class="clear">
                            ...
                            <li>
                                <asp:LinkButton ID="LinkButton2" runat="server" OnClick="LinkButton2_Click">My Ticket</asp:LinkButton></li>
                            <li>
                                <asp:LinkButton ID="LinkButton3" runat="server" OnClick="LinkButton3_Click">Create Ticket</asp:LinkButton></li>
                            <li>
                                <asp:LinkButton ID="LinkButton5" runat="server" OnClick="LinkButton5_Click">Blocklist</asp:LinkButton></li>
                            <li>
