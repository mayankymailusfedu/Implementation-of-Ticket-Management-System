...
<body id="top">
    ...
    <form id="form1" runat="server">
        <div class="bgded overlay" style="background-image: url('../images/demo/bg.png');">
                ...
                <header id="header" class="hoc clear">
                    ...
                    <nav id="mainav" class="fl_right">
                        <ul class="clear" style="padding-top: 30px; padding-bottom: 20px">
                            <li>
                                <asp:Button ID="ButtonAssign" runat="server" Text="Assign To Yourself" OnClick="ButtonAssign_Click" Style="background-color: Transparent;" /></li>
                            <li>
                                <asp:Button ID="ButtonBlock" runat="server" Text="Block" OnClick="ButtonBlock_Click" Style="background-color: Transparent;" /></li>
                            <li>
            ...
            <div style="padding-left: 100px; padding-right: 100px; padding-top: 50px">
                <div class="group btmspace-50">
                    <div class="one_third first">Change Ticket Status</div>
                    <div class="one_third">
                        <asp:TextBox ID="ctsTextBox1" runat="server" Style="color: black;"></asp:TextBox>
                    </div>
                    <div class="one_third">
                        <asp:Button ID="ctsButton" runat="server" Text="Change" OnClick="ctsLinkButton_Click" Style="background-color: Transparent;" />
                    </div>
                    <div class="group btmspace-50" style="padding-top: 50px;">
                        <div class="one_third first">Change Priority</div>
                        <div class="one_third">
                            <asp:TextBox ID="cpTextBox2" runat="server" Style="color: black;"></asp:TextBox>
                        </div>
                        <div class="one_third">
                            <asp:Button ID="cpButton" runat="server" Text="Change" OnClick="cpLinkButton_Click" Style="background-color: Transparent;" />
                        </div>
                    </div>
